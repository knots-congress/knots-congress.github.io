        ...
        [
          {
            ...
            description: "I’ll define a family of pivotal n-categories P(n,k, \beta) whose morphisms are constructed out of codimension-k submanifolds of balls.  P_2,1 reproduces Kauffman’s graphical version of the Temperly-Lieb tensor category.  This talk will focus on P_3,1 (a 3-category) and P_4,2 (a 4-category).  Each P_n,k has an associated (n+\epsilon)-dimensional TQFT.  One can also take quotients by tensor ideals for a discrete set of parameter values \beta (analogous to setting a Jones-Wenzl idempotent to zero). Both P_3,1 and P_4,2 contain subcategories isomorphic to Deligne’s Rep(S_t).  They also contain many other 1-parameter families of symmetric monoidal categories.  It is an open question to what extent these symmetric monoidal categories are genuinely new.",
          ...
          },
          {
            ...
            description: "It is an outstanding open question whether Jones polynomial (respectively, Khovanov homology, Khovanov-Lipshitz-Sarkar homotopy type) can be extended to all manifolds.They are originally defined in the case of the 3-sphere. \\ Louis H. Kauffman, Igor Nikonov, and the speaker used  enhanced Kauffman states, and gave the first partial solution in the case of Khovanov-Lipshitz-Sarkar homotopy type. They defined it in the case of thickened surfaces. ",
            start: "2025-02-03T02:00:00Z",
            duration: 1.0,
          }
        ],
      ...
      [ // part 2
        ...
        [
          ...
          },
          {
            ...
            description: "This talk is based on recent joint work Linda V. Alegria.\\ From classical knot theory we know that every knot in $S^3$ is the boundary of an oriented, embedded surface.  A standard demonstration of this fact achieved by elementary technique comes from taking a regular projection of any knot and employing Seifert's constructive algorithm.  In this note we give a natural generalization of Seifert's algorithm to any closed integral homology 3-sphere.  The starting point of our algorithm is presenting the handle structure of a Heegaard splitting of a given integral homology sphere as a planar diagram on the boundary of a $3$-ball.  (For a well known example of such a planar presentation, see the Poincar\'e homology sphere planar presentation in {\em Knots and Links} by Dale Rolfsen.)  An oriented link can then be represented by the regular projection of an oriented $k$-strand tangle.  From there we give a natural way to find a ``Seifert circle" and associated half-twisted bands.",
            start: "2025-02-04T19:00:00Z",
            duration: 1.0,
          },
          {
