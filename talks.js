      ...
      [ // part 2
        ...
        [
          ...
          },
          {
            ...
            description: "Imagine a 1D curve, then use it to fill a 2D manifold that covers an arbitrary 3D object – this computationally intensive materials challenge has been realized in the ancient technology known as knitting. This process for making functional materials 2D materials from 1D portable cloth dates back to prehistory, with the oldest known examples dating from the 11th century CE. Knitted textiles are ubiquitous as they are easy and cheap to create, lightweight, portable, flexible and stretchy. As with many functional materials, the key to knitting’s extraordinary properties lies in its microstructure. At the 1D level, knits are composed of an interlocking series of slip knots. At the most basic level there is only one manipulation that creates a knitted stitch – pulling a loop of yarn through another loop. However, there exist hundreds of books with thousands of patterns of stitches with seemingly unbounded complexity. The topology of knitted stitches has a profound impact on the geometry and elasticity of the resulting fabric <a href='program#matsumoto_singal'>[1]</a>. We have developed a formalization of the topology of two-periodic weft knitted textiles using a construction we call the swatch <a href='program#matsumoto_markande'>[2]<a/>. Using this construction, we can prove that all two-periodic weft knits form ribbon links <a href='program#matsumoto_kuzbary'>[3]</a>. This puts a new spin on additive manufacturing – not only can stitch pattern control the local and global geometry of a textile, but the creation process encodes mechanical properties within the material itself. Unlike standard additive manufacturing techniques, the innate properties of the yarn and the stitch microstructure has a direct effect on the global geometric and mechanical outcome of knitted fabrics.<br/><br/>The authors were partially supported by National Science Foundation grant DMR-1847172, by the Research Corporation for Science Advancement and by the International Center for Sustainability with Chiral Knotted Meta Matter (SKCM²). We would like to thank sarah-marie belcastro, Jen Hom, Jim McCann, Agniva Roy, Saul Schleimer and Henry Segerman for many fruitful conversations.<br/><br/><b>References</b><br/><br/><span id='matsumoto_singal'>[1]</span> K. Singal, M.S. Dimitriyev, S.E. Gonzalez, et al. Programming mechanics in knitted materials, stitch by stitch. Nat Commun 15, 2622 (2024).<br/><span id='matsumoto_markande'>[2]</span> S. Markande and S. Matsumoto, in: Proceedings of Bridges 2020: Mathematics, Art, Music, Architecture, Culture, (Tesselations Publishing, 2020), pp. 103–112.<br/><span id='matsumoto_kuzbary'>[3]</span> M. Kuzbary, S. Markande, S. Matsumoto and S. Pritchard, 2023.",
            start: "2025-02-05T19:00:00Z",
            duration: 1.0,
            moderators: ["Lucrezia Lorenzi", "Illia Rohozhkin"],
            zoom_link: "https://us06web.zoom.us/j/86473418315?pwd=nBY99agI3k9bQb1g1wlnaBbToK5YIg.1"
      ...
      [ // part 3
        ...
        [// section 2
          ...
          },
          {
            ...
            description: "In 1980 J. Powell proposed that, for every genus $g$, five specific elements suffice to generate the Goeritz group $G_g$ of genus $g$ Heegaard splittings of the $3$-sphere. Powell's Conjecture remains undecided for $g$ greater than $3$.  For each $g$, let $P_g$ in $G_g$ denote the subgroup generated by Powell's elements. Here we show that, for each genus $g$, the natural function $G_g \\rightarrow G_{g+1}/P_{g+1}$ is trivial.  More informally: for all $g$, the genus $g$ Goeritz group lies inside the genus $g+1$ Powell group.",
            start: "2025-02-06T03:00:00Z",
            duration: 1.0,
            moderators: ["Qingying Deng", "Seongjeong Kim"],
            zoom_link: "https://us06web.zoom.us/j/86473418315?pwd=nBY99agI3k9bQb1g1wlnaBbToK5YIg.1"
